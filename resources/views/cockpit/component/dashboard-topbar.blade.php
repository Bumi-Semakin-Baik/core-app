<header class="header header-sticky mb-4">
    <div class="container-fluid">
        ...
        <ul class="header-nav d-md-flex" id="topbar-container">
            <li class="nav-item"><a class="nav-link" href="{{ url('cockpit') }}">Dashboard</a></li>
        </ul>
    ...
    <div class="container-fluid">
        @include('cockpit.component.dashboard-breadcrumb')
    </div>
</header>
