        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12 text-center">
                    <h1 class="section-heading-jost-size28 text-pri2-color">Rp25,000,000 / Rp100,000,000</h1>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="widget-contact-services-details mg-bottom-25">
                                ...
                                <div class="text-center" style="margin-top: 2rem;margin-bottom: 2rem;"><a class="button-services" href="{{ url('donate-payment/2') }}">Donasi Sekarang</a></div>
                            </div>
                        </div>
                        <div class="col-md-12">
