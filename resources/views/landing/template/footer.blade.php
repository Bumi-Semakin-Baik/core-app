     ...
     <div class="container">
         <div class="row">
             <div class="col-12 text-center">
                 <div class="logo">
                     <a href="index.html"><img width="200px" src="{{ asset('landing/images/home/BumiBaik.png') }}"
                             alt="images"></a>
                 </div>
                 <div class="fadeInUp">
                     <div class="footer-item">
                         <div class="widgets-about padding-top-listfooter">
                             ...
                             <p class="text-decs">
                                 ...
                                 secara sukarela untuk menyerap emisi karbon sehingga karbon yang dihasilkan dan karbon
                                 yang diserap oleh pohon (Carbon Neutral) menjadi seimbang. BumiBaik memberikan
                                 informasi dan edukasi tentang dampak emisi karbon terhadap lingkungan dan isu perubahan
                                 iklim
                             </p>
                             <ul class="widgets-nav-social">
                                 <li><a href="https://wa.me/6282130075758" target="_blank"><i class="fa fa-whatsapp"
                                             aria-hidden="true"></i></a></li>
                                 <li><a href="https://www.instagram.com/bumi.baik/" target="_blank"><i
         ...
         <div class="container">
             <div class="row">
                 <div class="col-md-12">
                     <div class="copyright link-style4">
                         <p class="copyright-text">
                             copyright 2023 by BumiBaik
                         </p>
                     </div>
>>>>>>> cc991baec5148abc7d2e5302698f3c20957e192f
 ...
 <script src="{{ asset('landing/rev-slider/js/extensions/extensionsrevolution.extension.layeranimation.min.js') }}">
 </script>
 <script src="{{ asset('landing/rev-slider/js/extensions/extensionsrevolution.extension.migration.min.js') }}"></script>
 <script src="{{ asset('landing/rev-slider/js/extensions/extensionsrevolution.extension.navigation.min.js') }}">
 </script>
