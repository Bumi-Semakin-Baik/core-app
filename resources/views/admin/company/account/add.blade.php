...
<div class="nk-block nk-block-lg">
    ...
    <div class="card">
        <div class="card-inner">
            <form action="{{ route('store.company') }}" method="POST" enctype="multipart/form-data" class="form-validate">
            @csrf
                <div class="row g-gs">
                <div class="col-md-12">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                            <input type="email" class="form-control" id="fv-full-name" name="email" required>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                            <input type="text" class="form-control" id="fv-full-name" name="latitude" required>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    ...
                    <div class="col-md-12">
                                <button type="submit" class="btn btn-lg btn-primary"> Tambahkan Akun </button>
                            </form>
                        </div>
                    </div>
                </div>
