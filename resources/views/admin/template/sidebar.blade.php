                            ...
                            <ul class="nk-menu">
                                ...
                                <li class="nk-menu-item has-sub">
                                    ...
                                    <ul class="nk-menu-sub">
                                        <li class="nk-menu-item">
                                            <a href="{{url('/company/account')}}" class="nk-menu-link"><span class="nk-menu-text">Account</span></a>
                                        </li>
                                        <li class="nk-menu-item">
                                            <a href="{{url('/company/project')}}" class="nk-menu-link"><span class="nk-menu-text">Project List</span></a>
                                        </li>
                                    </ul><!-- .nk-menu-sub -->
                                </li><!-- .nk-menu-item -->
                                <li class="nk-menu-item">
